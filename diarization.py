...
class PyannoteDiarizationEngine(BaseDiarizationEngine):
    ...
    DEFAULT_CHECKPOINT = "pyannote/speaker-diarization-community-1"
    ...
    def diarize(
        ...
        **kwargs
        ...
        print(f"PYANNOTE MODEL LOADED: {checkpoint_path}", flush=True)
        ...
        if hasattr(diarization, "exclusive_speaker_diarization"):
            ...
            print("PYANNOTE USING: exclusive_speaker_diarization", flush=True)
        elif hasattr(diarization, "speaker_diarization"):
            annotation = diarization.speaker_diarization
            print("PYANNOTE USING: speaker_diarization", flush=True)
        else:
            annotation = diarization
            print("PYANNOTE USING: raw annotation", flush=True)
        diarization_df = pd.DataFrame(
